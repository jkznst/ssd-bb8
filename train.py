...
def parse_args():
    ...
    parser.add_argument('--train-path', dest='train_path', help='train record to use',
                        default=os.path.join(os.getcwd(), 'data', 'obj01', 'train.rec'), type=str)
    ...
    parser.add_argument('--val-path', dest='val_path', help='validation record to use',
                        default=os.path.join(os.getcwd(), 'data', 'obj01', 'val.rec'), type=str)
    ...
    parser.add_argument('--alpha-bb8', dest='alpha_bb8', type=float, default=1.,
                        help='The coefficient of bb8 loss.')
    parser.add_argument('--alpha-loc', dest='alpha_loc', type=float, default=1.,
                        help='The coefficient of loc loss.')
    parser.add_argument('--dilated', dest='use_dilated', type=bool, default=False,
                        help='use dilated convolutional layer in residual blocks')
    parser.add_argument('--focalloss', dest='focalloss', type=bool, default=False,
                        help='use focal loss during training')
...
if __name__ == '__main__':
    ...
    train_net(args.network, args.train_path,
              ...
              args.alpha_bb8, args.alpha_loc, args.use_dilated, args.focalloss,
