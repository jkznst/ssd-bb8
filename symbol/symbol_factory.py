...
def get_symbol_train(network, data_shape, alpha_bb8, alpha_loc, use_dilated, use_focalloss, **kwargs):
    ...
    return symbol_builder.get_symbol_train(alpha_bb8=alpha_bb8, alpha_loc=alpha_loc, use_dilated=use_dilated, use_focalloss=use_focalloss, **config)
