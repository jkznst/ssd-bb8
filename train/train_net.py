...
def train_net(network, train_path, num_classes, batch_size,
              ...
              momentum, weight_decay, lr_refactor_step, lr_refactor_ratio, alpha_bb8=1.0, alpha_loc=1.0, use_dilated=False, use_focalloss=False,
    ...
    # load symbol
    net = get_symbol_train(network, data_shape[1], alpha_bb8, alpha_loc, use_dilated, use_focalloss, num_classes=num_classes,
